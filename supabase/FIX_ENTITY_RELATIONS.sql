-- ============================================
-- FIX: Recrear entity_relations con estructura correcta
-- ============================================

-- 1. ELIMINAR tablas existentes
DROP VIEW IF EXISTS top_relations CASCADE;
DROP VIEW IF EXISTS entity_stats CASCADE;
DROP TABLE IF EXISTS citations CASCADE;
DROP TABLE IF EXISTS entity_relations CASCADE;

-- 2. RECREAR entity_relations con TODAS las columnas
...
-- Verificar columnas de entity_relations
